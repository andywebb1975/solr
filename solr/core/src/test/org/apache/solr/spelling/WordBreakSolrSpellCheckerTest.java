...
public class WordBreakSolrSpellCheckerTest extends SolrTestCaseJ4 {
  ...
  public static void beforeClass() throws Exception {
    ...
    assertNull(
        h.validateUpdate(adoc("id", "0", "lowerfilt", "pain table paintablepine pi ne in able")));
  ...
  public void testStandAlone() throws Exception {
    ...
    for (Map.Entry<Token, LinkedHashMap<String, SuggestWord>> s : result.getSuggestions().entrySet()) {
      Token orig = s.getKey();
  ...
  public void testInConjunction() {
    assertQ(
        req(
            ...
            "true",
            SpellCheckComponent.SPELLCHECK_ACCURACY,
            ".75",
