...
You can customize this tokenizer's behavior by specifying https://unicode-org.github.io/icu/userguide/boundaryanalysis/break-rules.html[per-script rule files].
